...
const ɵ0 = { title: 'dasboard' }, ɵ1 = { title: 'HeroDetail' }, ɵ2 = { title: 'hero' };
exports.ɵ0 = ɵ0;
exports.ɵ1 = ɵ1;
exports.ɵ2 = ɵ2;
const routes = [
    { path: '', redirectTo: '/dashboard', pathMatch: 'full' },
    { path: 'dashboard', component: dashboard_component_1.DashboardComponent, data: ɵ0 },
    { path: 'detail/:id', component: hero_detail_component_1.HeroDetailComponent, data: ɵ1 },
    { path: 'heroes', component: heroes_component_1.HeroesComponent, data: ɵ2 }
];
...
const i9 = __webpack_require__(/*! ./seo.service */ "./src/app/seo.service.ts");
...
function View_AppComponent_0(_l) { return i1.ɵvid(0, [(_l()(), i1.ɵeld(0, 0, null, null, 6, "nav", [], null, null, null, null, null)), (_l()(), i1.ɵeld(1, 0, null, null, 2, "a", [["routerLink", "/dashboard"]], [[1, "target", 0], [8, "href", 4]], [[null, "click"]], function (_v, en, $event) { var ad = true; if (("click" === en)) {
        ...
        ad = (pd_0 && ad);
    } return ad; }, null, null)), i1.ɵdid(5, 671744, null, 0, i2.RouterLinkWithHref, [i2.Router, i2.ActivatedRoute, i3.LocationStrategy], { routerLink: [0, "routerLink"] }, null), (_l()(), i1.ɵted(-1, null, ["Heroes"])), (_l()(), i1.ɵeld(7, 16777216, null, null, 1, "router-outlet", [], null, null, null, null, null)), i1.ɵdid(8, 212992, null, 0, i2.RouterOutlet, [i2.ChildrenOutletContexts, i1.ViewContainerRef, i1.ComponentFactoryResolver, [8, null], i1.ChangeDetectorRef], null, null), (_l()(), i1.ɵeld(9, 0, null, null, 1, "app-messages", [], null, null, null, i4.View_MessagesComponent_0, i4.RenderType_MessagesComponent)), i1.ɵdid(10, 114688, null, 0, i5.MessagesComponent, [i6.MessageService], null, null)], function (_ck, _v) { var currVal_2 = "/dashboard"; _ck(_v, 2, 0, currVal_2); var currVal_5 = "/heroes"; _ck(_v, 5, 0, currVal_5); _ck(_v, 8, 0); _ck(_v, 10, 0); }, function (_ck, _v) { var currVal_0 = i1.ɵnov(_v, 2).target; var currVal_1 = i1.ɵnov(_v, 2).href; _ck(_v, 1, 0, currVal_0, currVal_1); var currVal_3 = i1.ɵnov(_v, 5).target; var currVal_4 = i1.ɵnov(_v, 5).href; _ck(_v, 4, 0, currVal_3, currVal_4); }); }
exports.View_AppComponent_0 = View_AppComponent_0;
function View_AppComponent_Host_0(_l) { return i1.ɵvid(0, [(_l()(), i1.ɵeld(0, 0, null, null, 1, "app-root", [], null, null, null, View_AppComponent_0, RenderType_AppComponent)), i1.ɵdid(1, 114688, null, 0, i7.AppComponent, [i8.Title, i2.Router, i2.ActivatedRoute, i9.SeoService], null, null)], function (_ck, _v) { _ck(_v, 1, 0); }, null); }
...
const seo_service_1 = __webpack_require__(/*! ./seo.service */ "./src/app/seo.service.ts");
class AppComponent {
    constructor(titleService, router, activatedRoute, seoService) {
    ...
    ngOnInit() {
        this.router.events
            ...
            .pipe(operators_1.map(() => this.activatedRoute))
            .pipe(operators_1.map((route) => {
            while (route.firstChild) {
                route = route.firstChild;
            }
            return route;
        }))
            .pipe(operators_1.filter((route) => route.outlet === 'primary'))
            .pipe(operators_1.mergeMap((route) => route.data))
...
const i21 = __webpack_require__(/*! ./seo.service */ "./src/app/seo.service.ts");
...
const i8 = __webpack_require__(/*! ../seo.service */ "./src/app/seo.service.ts");
...
function View_DashboardComponent_Host_0(_l) { return i1.ɵvid(0, [(_l()(), i1.ɵeld(0, 0, null, null, 1, "app-dashboard", [], null, null, null, View_DashboardComponent_0, RenderType_DashboardComponent)), i1.ɵdid(1, 114688, null, 0, i7.DashboardComponent, [i6.HeroService, i8.SeoService], null, null)], function (_ck, _v) { _ck(_v, 1, 0); }, null); }
...
class DashboardComponent {
    constructor(heroService, seoService) {
...
const i5 = __webpack_require__(/*! ../hero.service */ "./src/app/hero.service.ts");
const i6 = __webpack_require__(/*! ../seo.service */ "./src/app/seo.service.ts");
...
function View_HeroesComponent_Host_0(_l) { return i1.ɵvid(0, [(_l()(), i1.ɵeld(0, 0, null, null, 1, "app-heroes", [], null, null, null, View_HeroesComponent_0, RenderType_HeroesComponent)), i1.ɵdid(1, 114688, null, 0, i4.HeroesComponent, [i5.HeroService, i6.SeoService], null, null)], function (_ck, _v) { _ck(_v, 1, 0); }, null); }
...
class SeoService {
    ...
    defaultSeo(pageName, seoResponse) {
    ...
    getSeo(pageName) {
        ...
        for (let i = 0; i <= seoProperty.length; i++) {
            this.metaService.updateTag({ name: seoProperty[i].name, property: seoProperty[i].property, content: seoProperty[i].content });
        }
...
module.exports = __webpack_require__(/*! /Users/prabhjotsingh/IdeaProjects/universal/src/main.server.ts */"./src/main.server.ts");
